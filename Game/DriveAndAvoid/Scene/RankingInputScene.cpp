...
RankingInputScene::RankingInputsScene() : background_image(NULL), ranking(nullptr), score(0), name_num(0), cursor_x(0),
cursor_y(0)
{
...
{
	//画像の読み込み
	background_image = LoadGraph("Resource/images/Ranking.tmp");
...
bool RankingInputScene::InputName()
{
	...
	//カーソル位置の文字を決定する
	if (InputControl::GetButtonDown(XINPUT_BUTTON_BUTTON_B))
	{
		if (cursor_y < 2)
		{
